...
import logo from "../Images/images.png"; // Assurez-vous que le chemin d'accès à votre image est correct
        ...
        <MDBRow className="Row">
          ...
          <MDBCol className="col-form">
            ...
            <div className="text-center text-md-start mt-4 pt-2">
              <MDBBtn type="submit" className="mb-0 px-5 button-large" size="lg">
